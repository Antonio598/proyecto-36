            ...
            <div className="space-y-6 border-t border-gray-100 pt-6">
              ...
              {patient.cedula_pasaporte && (
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Cédula / Pasaporte</p>
                    <p className="text-sm font-bold text-black">{patient.cedula_pasaporte}</p>
                  </div>
                </div>
              )}
              ...
              {patient.edad && (
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-bold text-black">{patient.edad} años</p>
                  </div>
                </div>
              )}
